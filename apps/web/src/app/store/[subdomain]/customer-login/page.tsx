...
export default function CustomerLoginPage() {
  ...
  const LoginPageComponent = themeComponents.LoginPage
  if (!LoginPageComponent) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-gray-500">Page de connexion non disponible</p>
      </div>
    )
  }
  ...
  return (
    <LoginPageComponent
      ...
      sections={storeData.pages?.login?.sections}
      subdomain={subdomain}
