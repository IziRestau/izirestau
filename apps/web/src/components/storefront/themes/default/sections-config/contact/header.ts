...
export const contactHeaderSection: ThemeSectionDef = {
  id: 'header',
  label: 'En-tête de page',
  description: 'Titre et introduction de la page contact',
  fields: [
    {
      key: 'bgType',
    ...
    },
    {
      ...
      defaultValue: 'Une question ? N\'hésitez pas à nous contacter',
    },
  ],
}
