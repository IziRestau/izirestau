...
export const thanksHeaderSection: ThemeSectionDef = {
  id: 'header',
  label: 'En-tête de page',
  description: 'Titre et introduction de la page de confirmation',
  fields: [
    {
      key: 'bgType',
    ...
    },
    {
      ...
      label: 'Sous-titre',
      type: 'text',
      placeholder: 'Votre commande a bien été enregistrée',
      defaultValue: 'Votre commande a bien été enregistrée',
    },
  ],
}
